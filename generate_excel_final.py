...
filepath = r'd:\Office Excel\Business_Ledger_Final.xlsx'
...
# Summing the Total Due column from Customers sheet
...
# Add conditional formatting to Total Due column (E)
...
for row in range(1, 305):  
    ...
    # WhatsApp Hyperlink Formula (Using Bengali text)
    # Replaces spaces in name and constructs WA link. If no number, leave blank.
...
ws_customers.write(1, 2, '01720643322', cell_format) # Numbers should ideally not have hyphens for WA to work smoothly
...
# Adding an Excel Table for easy filtering/slicers
...
for row in range(1, 1005): 
    # Data validation points to Customer Name
...
# Add a cleared balance example to show green formatting
...
workbook.close()
print("Final Excel file with Magic Features generated successfully!")
