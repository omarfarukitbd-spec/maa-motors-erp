...
filepath = r'd:\Office Excel\Business_Ledger_Pro_Final.xlsx'
...
ws_dash.hide_gridlines(2) # Hide gridlines for cleaner UI
ws_dash.protect('451060') 
...
ws_customers.freeze_panes(3, 0) # Freeze headers at row 3
...
# 1. Search Highlight (Applies to A4:F305)
...
# 2. Red/Green for Due (Applies to E4:E305)
...
for row in range(1, 1004): 
    ws_ledger.set_row(row, 18) # Slightly taller rows for better UX
...
workbook.close()
print("Business_Ledger_Pro_Final generated successfully!")
