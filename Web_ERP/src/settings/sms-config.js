...
export async function unlockSmsSettings() {
    ...
    const fields = ['set-sms-reminder', 'set-sms-opening', 'set-sms-new-bill', 'set-sms-payment', 'set-sms-less', 'set-sms-correction', 'set-sms-api', 'set-sms-sender', 'set-sms-auto'];
    fields.forEach(id => {
