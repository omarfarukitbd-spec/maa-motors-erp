        ...
        html: `
            <div class="space-y-4 text-left p-1 font-bn">
                ...
                <div>
                    ...
                    <input id="ed-ib" class="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-emerald-400 font-bold outline-none focus:border-emerald-500 text-sm" value="${currentInitialDue}" oninput="handleNumberInput(this); updateLiveWords(this, 'ed-ib-words');">
