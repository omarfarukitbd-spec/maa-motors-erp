        ...
        <div class="font-bn space-y-4">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 pb-2">
                ...
                <div class="flex items-center gap-2">
                    <button data-perm="editBank" onclick="window.bankingApp.openAnchorModal('${accountName}', ${isCash})" class="bg-purple-600/20 border border-purple-500/40 hover:bg-purple-600 text-purple-300 hover:text-white px-3 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-md" title="প্রারম্ভিক ব্যালেন্স ও শুরুর তারিখ কনফিগার করুন"><i class="fa-solid fa-sliders text-purple-400 text-xs"></i> প্রারম্ভিক ব্যালেন্স</button>
