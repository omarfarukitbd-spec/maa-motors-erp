const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dao-DWBGBcb5.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/vendor-firebase-DBzLY9-F.js","assets/vendor-COdl40C-.js","assets/vendor-CwbMEznW.css","assets/receipt-engine-DnjFXK3T.js","assets/vendor-ui-n4g2UPZQ.js","assets/vendor-ui-CveviJq_.css","assets/statement-print-DuOBGlVE.js","assets/zone-report-tagada-BqNhQILn.js"])))=>i.map(i=>d[i]);
    ...
    `,await Ls()}async function Ls(){try{let e=await p.getActiveBanks(),t=await u.getActiveCollectors();Fs=[...e.map(e=>({...e,isCash:!1})),...t.map(e=>({...e,isCash:!0}))];let n=``;if(Fs.length===0)n=`<div class="col-span-full text-center py-12 text-slate-400 font-bold">এখনো কোনো ব্যাংক বা ক্যাশ অ্যাকাউন্ট যুক্ত করা হয়নি।</div>`;else{let e=await Promise.all(Fs.map(e=>Os(e.name,e.isCash)));Fs.forEach((t,r)=>{let i=e[r],a=t.isCash?`<i class="fa-solid fa-wallet text-emerald-400 text-2xl"></i>`:`<i class="fa-solid fa-building-columns text-blue-400 text-2xl"></i>`,o=t.isCash?`<span class="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">CASH</span>`:`<span class="px-2 py-0.5 rounded text-[10px] font-bold bg-blue-500/10 text-blue-400 border border-blue-500/20">BANK</span>`;n+=`
                    <div class="m3-card relative overflow-hidden group cursor-pointer hover:border-purple-500/50 transition-colors" onclick="window.bankingApp.viewAccountLedger('${t.name}', ${t.isCash})">
                        ...
                        <div>
                            ...
                            <div class="text-3xl font-black ${i<0?`text-red-400`:`text-white`}">৳ ${N(i)}</div>
                        </div>
