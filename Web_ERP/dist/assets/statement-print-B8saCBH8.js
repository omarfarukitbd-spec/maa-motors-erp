<<<<<<<< Updated upstream:Web_ERP/dist/assets/statement-print-CjlPzehm.js
const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dao-CJcWJLH8.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/vendor-firebase-YQIUDKRL.js","assets/vendor-CJahiyzm.js","assets/vendor-CwbMEznW.css"])))=>i.map(i=>d[i]);
import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{i as t}from"./dao-CJcWJLH8.js";import{O as n}from"./customer-state-BjmbWZzG.js";import{c as r,d as i,o as a,s as o}from"./ui-helpers-BkH1xB3j.js";import{n as s}from"./vendor-ui-n4g2UPZQ.js";import{r as c,t as l}from"./smart-print-engine-B0360BA8.js";var u=e(s());function d(e,t){let n=[],r=e,a=`<tr style="background:#f1f5f9; border-bottom:2px solid #cbd5e1;">
========
const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dao-CEhZeF_s.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/vendor-firebase-YQIUDKRL.js","assets/vendor-CJahiyzm.js","assets/vendor-CwbMEznW.css"])))=>i.map(i=>d[i]);
import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{o as t}from"./dao-CEhZeF_s.js";import{D as n}from"./customer-state-BMDMRtAn.js";import{c as r,d as i,o as a,s as o}from"./ui-helpers-BkH1xB3j.js";import{n as s}from"./vendor-ui-n4g2UPZQ.js";import{r as c,t as l}from"./smart-print-engine-B0360BA8.js";var u=e(s());function d(e,t){let n=[],r=e,a=`<tr style="background:#f1f5f9; border-bottom:2px solid #cbd5e1;">
>>>>>>>> Stashed changes:Web_ERP/dist/assets/statement-print-B8saCBH8.js
    ...
    </tr>`;return n.push({html:a,textLength:15}),t.forEach(e=>{let t=Number(e.bill)||0,a=Number(e.paid)||0,s=e.receivedType||``;r+=t-a;let c=a>0?s===`Less`?`<strong style="color:#0f172a;">[LESS]</strong>`:`<strong style="color:#0f172a;">${s}</strong>`:`-`;a>0&&e.receivedFrom&&(c+=`<br><span style="font-size:9px;color:#475569;">${e.receivedFrom}</span>`);let l=e.voucherNo&&e.voucherNo!==`OPENING`?`<br><span style="font-size:9px;color:#0f172a;font-weight:900;">#${e.voucherNo}</span>`:``,u=`<tr>
            <td style="font-size:11px; border-bottom:1px solid #e2e8f0; padding: 6px 12px; color:#0f172a;">${o(e.date)}</td>
        ...
        </tr>`;n.push({html:u,textLength:(e.receivedFrom||``).length})}),{rowsArray:n,running:r}}function f(e,t,n,r,i,o,s,c,l){return{page1HeaderHtml:a(o,{title:s,subtitle:c,dateRangeStr:l}),repeatHeaderHtml:`
    ...
    `}}async function p(e,n,i,a=``){try{let s=await t.getAppSettings(),u=document.getElementById(`print-receipt-container`);u||(u=document.createElement(`div`),u.id=`print-receipt-container`,document.body.appendChild(u));let p=document.getElementById(`stmt-start-date`)?.value||``,m=document.getElementById(`stmt-end-date`)?.value||``,h=p||m?`${p?o(p):`শুরু`} হতে ${m?o(m):`আজ`}`:`সকল লেনদেন`,g=document.getElementById(`stmt-total-bill`)?.innerText||`৳ 0`,_=document.getElementById(`stmt-total-paid`)?.innerText||`৳ 0`,v=document.getElementById(`stmt-total-due`)?.innerText||`৳ 0`,{rowsArray:y,running:b}=d(n,i),{page1HeaderHtml:x,repeatHeaderHtml:S,page1ExtraHtml:C,tableColHeaderHtml:w,signatureHtml:T}=f(e,g,_,v,b,s,`CUSTOMER KHATIYAN`,`কাস্টমার বকেয়া খতিয়ান`,h),E=a&&a.trim()?`
            <div style="margin-top: 15px; padding: 10px 14px; background: #fffbe6; border: 1px solid #ffe58f; border-radius: 8px; font-size: 11px; color: #856404; font-family: sans-serif; page-break-inside: avoid; break-inside: avoid;">
                ...
                ${a.replace(/\n/g,`<br>`)}
            </div>`:``,[D,O,k]=r().split(`-`),A=await c({rowsArray:y,page1HeaderHtml:x,repeatHeaderHtml:S,tableColHeaderHtml:w,page1ExtraHtml:C,summaryHtml:E,signatureHtml:T,formattedDate:`${k}/${O}/${D}`});l(A)}catch(e){console.error(`Statement print error:`,e),u.default.fire(`Error`,`প্রিন্ট করতে সমস্যা হয়েছে`,`error`)}}var m=null;async function h(e){if(!e)return;let t=document.getElementById(`login-screen`),r=document.getElementById(`app-container`);t&&(t.style.display=`none`),r&&r.classList.add(`hidden`);let a=document.getElementById(`public-stmt-view`);a||(a=document.createElement(`div`),a.id=`public-stmt-view`,a.className=`fixed inset-0 z-[9999] overflow-y-auto bg-slate-950 p-3 sm:p-6 font-bn flex flex-col items-center justify-start`,document.body.appendChild(a)),a.innerHTML=`<div class="text-center py-20 text-white font-bold"><i class="fa-solid fa-spinner fa-spin text-2xl text-blue-500 mb-3"></i><p>মেসার্স মা মোটরস্ বিবরণী লোড হচ্ছে...</p></div>`;try{let{CustomerDAO:t,TransactionDAO:r,SettingsDAO:o}=await n(async()=>{let{CustomerDAO:e,TransactionDAO:t,SettingsDAO:n}=await import(`./dao-CEhZeF_s.js`).then(e=>e.u);return{CustomerDAO:e,TransactionDAO:t,SettingsDAO:n}},__vite__mapDeps([0,1,2,3,4])),s=await t.getById(e);if(!s)return a.innerHTML=`<div class="m3-card text-center py-12 text-red-400 font-bold max-w-md mx-auto">কাস্টমার হিসাব পাওয়া যায়নি!</div>`;let c=await o.getAppSettings(),l=(await r.getByCustomer(e)).filter(e=>e.voucherNo!==`OPENING`);l.sort((e,t)=>{let n=new Date(e.date)-new Date(t.date);return n===0?(e.createdAt?.toMillis()||0)-(t.createdAt?.toMillis()||0):n});let u=Number(s.initialDue||0),p=0,h=0,g=0;l.forEach(e=>{e.receivedType===`Less`?g+=Number(e.paid)||0:h+=Number(e.paid)||0,p+=Number(e.bill)||0});let _=u+p-h-g,{rowsArray:v}=d(u,l);m={customer:s,docs:l,settings:c,initialDue:u,billSum:p,paidSum:h,lessSum:g,running:_};let{page1HeaderHtml:y,page1ExtraHtml:b}=f(s,`৳ ${i(p)}`,`৳ ${i(h)}`,`৳ ${i(Math.abs(_))} ${_<0?`(Adv)`:``}`,_,c,`STATEMENT SUMMARY`,`সকল লেনদেন`,`সকল লেনদেন`);a.innerHTML=`
            <div class="w-full max-w-4xl bg-slate-900 rounded-3xl border border-slate-800 p-4 sm:p-6 shadow-2xl mb-6 font-bn">
                ...
                <div id="public-print-area" class="bg-white text-slate-900 p-4 sm:p-8 rounded-2xl">
                    ...
                    <table style="width:100%; border-collapse:collapse; margin-bottom:12px; border: 1px solid #cbd5e1;">
                        ...
                        <tbody style="font-size: 10px;">${v.join(``)}</tbody>
                    </table>
        ...
        `}catch(e){console.error(e),a.innerHTML=`<div class="m3-card text-center py-12 text-red-400 font-bold max-w-md mx-auto">স্টেটমেন্ট লোড করতে ব্যর্থ!</div>`}}window.printPublicStatement=async()=>{if(!m)return;let{customer:e,docs:t,settings:n,initialDue:a,billSum:o,paidSum:s,running:u}=m,p=document.getElementById(`print-receipt-container`);p||(p=document.createElement(`div`),p.id=`print-receipt-container`,document.body.appendChild(p));let{rowsArray:h}=d(a,t),{page1HeaderHtml:g,repeatHeaderHtml:_,page1ExtraHtml:v,tableColHeaderHtml:y,signatureHtml:b}=f(e,`৳ ${i(o)}`,`৳ ${i(s)}`,`৳ ${i(Math.abs(u))} ${u<0?`(Adv)`:``}`,u,n,`STATEMENT SUMMARY`,`সকল লেনদেন`,`সকল লেনদেন`),[x,S,C]=r().split(`-`),w=await c({rowsArray:h,page1HeaderHtml:g,repeatHeaderHtml:_,tableColHeaderHtml:y,page1ExtraHtml:v,summaryHtml:``,signatureHtml:b,formattedDate:`${C}/${S}/${x}`});l(w)},window.renderPublicStatementView=h;export{p as printStatement,h as renderPublicStatementView};