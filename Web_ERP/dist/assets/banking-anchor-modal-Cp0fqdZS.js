import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{i as t,n}from"./dao-BnyW6Avn.js";import{i as r}from"./audit-DMfeQur4.js";import{_ as i,m as a,o,y as s}from"./ui-helpers-vB-cDBaI.js";import{n as c}from"./vendor-ui-n4g2UPZQ.js";import{i as l}from"./index-DJpgSO_I.js";var u=e(c());async function d(e,c,d){let f=c?t:n,p=c?`ক্যাশ বক্স`:`ব্যাংক অ্যাকাউন্ট`;u.default.fire({title:`লোড হচ্ছে...`,allowOutsideClick:!1,didOpen:()=>u.default.showLoading(),customClass:{popup:`!bg-slate-900 !text-white !rounded-3xl border border-slate-700`}});let m={effectiveStartDate:`2026-09-01`,openingBalance:0,docId:null};try{let t=await f.collection.where(`name`,`==`,e).limit(1).get();if(!t.empty){let e=t.docs[0],n=e.data();m.docId=e.id,n.effectiveStartDate&&(m.effectiveStartDate=a(n.effectiveStartDate)),n.openingBalance!==void 0&&!isNaN(Number(n.openingBalance))&&(m.openingBalance=Number(n.openingBalance))}}catch(e){console.error(`Error fetching account anchor:`,e)}let h=`
