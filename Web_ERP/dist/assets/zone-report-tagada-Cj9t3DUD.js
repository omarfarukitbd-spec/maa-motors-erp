import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{o as t}from"./dao-D2JpYQwn.js";import"./customer-state-BTqZD9bd.js";import{c as n,d as r,o as i,p as a,u as o}from"./ui-helpers-IvKNSVag.js";import{n as s}from"./vendor-ui-n4g2UPZQ.js";import{n as c,t as l}from"./smart-print-engine-B0360BA8.js";var u=e(s());async function d(e){let{customers:s}=e,d=e.selectedZone,f=s.filter(e=>(!d||(e.zone||``).trim()===d)&&(Number(e.totalDue)||0)>0);if(f.length===0)return u.default.fire(`তালিকায় কোনো বকেয়া কাস্টমার নেই`,`সিলেক্ট করা জোনে কোনো বকেয়াওয়ালা কাস্টমার পাওয়া যায়নি।`,`warning`);f.sort((e,t)=>(Number(t.totalDue)||0)-(Number(e.totalDue)||0));let p=await t.getAppSettings(),m=d?`${d} জোনের ফিল্ড তাগাদা ও আদায় রেজিস্টার`:`সকল জোনের ফিল্ড তাগাদা ও আদায় রেজিস্টার`,h=0;f.forEach(e=>h=a(h+(Number(e.totalDue)||0)));let[g,_,v]=n().split(`-`),y=`${v}/${_}/${g}`,b=i(p,{title:d?`${d} TAGADA SHEET`:`FIELD TAGADA SHEET`,subtitle:`${m} • ${y}`}),x=`
    ...
    `,S=f.map((e,t)=>{let n=t%2==0?`background: #ffffff;`:`background: #f8fafc;`,i=Number(e.totalDue)||0;return`
