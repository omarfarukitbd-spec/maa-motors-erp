...
import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{s as t}from"./dao-CJk3sbx1.js";import{a as n}from"./audit-BuamRIjn.js";import{_ as r,b as i,c as a,f as o,l as s,p as c}from"./ui-helpers-vB-cDBaI.js";import{n as l}from"./vendor-ui-n4g2UPZQ.js";import{r as u,t as d}from"./index-DwVPRLPq.js";var f=e(l());function p(e,t){let n=[],a=e,c=`<tr style="background:#f1f5f9; border-bottom:2px solid #cbd5e1;">
    ...
    `}}async function h(e,n,a,o=``){try{let l=await t.getAppSettings(),f=document.getElementById(`print-receipt-container`);f||(f=document.createElement(`div`),f.id=`print-receipt-container`,document.body.appendChild(f));let h=document.getElementById(`stmt-start-date`)?.value||``,g=document.getElementById(`stmt-end-date`)?.value||``,_=h||g?`${h?s(h):`শুরু`} হতে ${g?s(g):`আজ`}`:`সকল লেনদেন`,v=0,y=0;(a||[]).forEach(e=>{v=i(v+(Number(e.bill)||0)),y=i(y+(Number(e.paid)||0))});let{rowsArray:b,running:x}=p(n,a),{page1HeaderHtml:S,repeatHeaderHtml:C,page1ExtraHtml:w,tableColHeaderHtml:T,signatureHtml:E}=m(e,`৳ ${r(v)}`,`৳ ${r(y)}`,`৳ ${r(Math.abs(x))} ${x<0?`(Adv)`:``}`,x,l,`CUSTOMER KHATIYAN`,`কাস্টমার বকেয়া খতিয়ান`,_),D=o&&o.trim()?`
