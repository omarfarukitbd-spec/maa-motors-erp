const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dao-BctEXtfh.js","assets/rolldown-runtime-Dd_uD5pT.js","assets/vendor-firebase-BClu8lYp.js","assets/vendor-3SwtfBWZ.js","assets/vendor-CwbMEznW.css"])))=>i.map(i=>d[i]);
import{i as e}from"./rolldown-runtime-Dd_uD5pT.js";import{s as t}from"./dao-BctEXtfh.js";import{a as n}from"./audit-B-2BTDNi.js";import{_ as r,b as i,c as a,f as o,l as s,m as c,p as l}from"./ui-helpers-ChDNPFdp.js";import{n as u}from"./vendor-ui-n4g2UPZQ.js";import{r as d,t as f}from"./index-UQDU7AkD.js";var p=e(u());function m(e,t){let n=[],a=e,c=`<tr style="background:#f1f5f9; border-bottom:2px solid #cbd5e1;">
        ...
        <td style="text-align:right; font-weight:900; color:#0f172a; padding: 8px 12px; border-left:1px solid #cbd5e1; background:#fff;">
    ...
    </tr>`;return n.push({html:c,textLength:15}),t.forEach(e=>{let t=Number(e.bill)||0,c=Number(e.paid)||0;e.receivedType,a=i(a+(t-c));let l=``;if(e.createdAt)try{let t=e.createdAt.toDate?e.createdAt.toDate():e.createdAt.toMillis?new Date(e.createdAt.toMillis()):new Date(e.createdAt);isNaN(t.getTime())||(l=t.toLocaleTimeString(`en-US`,{hour:`numeric`,minute:`2-digit`,hour12:!0}))}catch(e){console.error(`Time parsing error in statement print:`,e)}let u=`-`;if(c>0){let t=e.receivedType||`Bank`,n=(e.receivedFrom||``).trim(),r=n?`${t}: ${n}`:t;u=t===`Less`?`<strong style="color:#7c3aed; font-size:10px; background:#f5f3ff; border:1px solid #ddd6fe; padding:1px 6px; border-radius:5px; display:inline-block;">[LESS] ${n||``}</strong>`:t===`Bank`?`<strong style="color:#0284c7; font-size:10px; background:#f0f9ff; border:1px solid #bae6fd; padding:1px 6px; border-radius:5px; display:inline-block;">${r}</strong>`:`<strong style="color:#059669; font-size:10px; background:#ecfdf5; border:1px solid #a7f3d0; padding:1px 6px; border-radius:5px; display:inline-block;">${r}</strong>`}else t>0&&e.notes&&(u=`<span style="font-size:10px; color:#475569;">${e.notes}</span>`);let d=e.voucherNo&&e.voucherNo!==`OPENING`?`<span style="font-size:9.5px; color:#0284c7; font-weight:900; font-family:monospace; margin-left:4px;">#${e.voucherNo}</span>`:``,f=`<tr>
            ...
            <td style="text-align:right; color:#059669; font-weight:700; border-bottom:1px solid #e2e8f0; padding: 5px 10px; vertical-align: middle;">${c>0?r(c):`-`}</td>
        ...
        </tr>`;n.push({html:f,textLength:(e.receivedFrom||``).length})}),{rowsArray:n,running:a}}function h(e,t,n,r,i,o,s,c,l){let u=(e.name||``).replace(/^\[.*?\]\s*/,``).trim();return{page1HeaderHtml:a(o,{title:s,subtitle:c,dateRangeStr:l}),repeatHeaderHtml:`
    ...
    `}}async function g(e,n,a,o=``){try{let c=await t.getAppSettings(),u=document.getElementById(`print-receipt-container`);u||(u=document.createElement(`div`),u.id=`print-receipt-container`,document.body.appendChild(u));let p=document.getElementById(`stmt-start-date`)?.value||``,g=document.getElementById(`stmt-end-date`)?.value||``,_=p||g?`${p?s(p):`শুরু`} হতে ${g?s(g):`আজ`}`:`সকল লেনদেন`,v=0,y=0;(a||[]).forEach(e=>{v=i(v+(Number(e.bill)||0)),y=i(y+(Number(e.paid)||0))});let{rowsArray:b,running:x}=m(n,a),{page1HeaderHtml:S,repeatHeaderHtml:C,page1ExtraHtml:w,tableColHeaderHtml:T,signatureHtml:E}=h(e,`৳ ${r(v)}`,`৳ ${r(y)}`,`৳ ${r(Math.abs(x))} ${x<0?`(Adv)`:``}`,x,c,`CUSTOMER KHATIYAN`,`কাস্টমার বকেয়া খতিয়ান`,_),D=o&&o.trim()?`
            <div style="margin-top: 15px; padding: 10px 14px; background: #fffbe6; border: 1px solid #ffe58f; border-radius: 8px; font-size: 11px; color: #856404; font-family: sans-serif; page-break-inside: avoid; break-inside: avoid;">
                ...
                ${o.replace(/\n/g,`<br>`)}
            </div>`:``,[O,k,A]=l().split(`-`),j=await d({rowsArray:b,page1HeaderHtml:S,repeatHeaderHtml:C,tableColHeaderHtml:T,page1ExtraHtml:w,summaryHtml:D,signatureHtml:E,formattedDate:`${A}/${k}/${O}`});f(j)}catch(e){console.error(`Statement print error:`,e),p.default.fire(`Error`,`প্রিন্ট করতে সমস্যা হয়েছে`,`error`)}}var _=null;async function v(e){if(!e)return;let t=document.getElementById(`login-screen`),a=document.getElementById(`app-container`);t&&(t.style.display=`none`),a&&a.classList.add(`hidden`);let o=document.getElementById(`public-stmt-view`);o||(o=document.createElement(`div`),o.id=`public-stmt-view`,o.className=`fixed inset-0 z-[9999] overflow-y-auto bg-slate-950 p-3 sm:p-6 font-bn flex flex-col items-center justify-start`,document.body.appendChild(o)),o.innerHTML=`<div class="text-center py-20 text-white font-bold"><i class="fa-solid fa-spinner fa-spin text-2xl text-blue-500 mb-3"></i><p>মেসার্স মা মোটরস্ বিবরণী লোড হচ্ছে...</p></div>`;try{let{CustomerDAO:t,TransactionDAO:a,SettingsDAO:s}=await n(async()=>{let{CustomerDAO:e,TransactionDAO:t,SettingsDAO:n}=await import(`./dao-BctEXtfh.js`).then(e=>e.d);return{CustomerDAO:e,TransactionDAO:t,SettingsDAO:n}},__vite__mapDeps([0,1,2,3,4])),l=await t.getById(e);if(!l)return o.innerHTML=`<div class="m3-card text-center py-12 text-red-400 font-bold max-w-md mx-auto">কাস্টমার হিসাব পাওয়া যায়নি!</div>`;let u=await s.getAppSettings(),d=(await a.getByCustomer(e)).filter(e=>{let t=String(e.voucherNo||``).trim().toUpperCase();return t!==`OPENING`&&t!==`OPEN`&&t!==`প্রারম্ভিক ব্যালেন্স`&&t!==`প্রারম্ভিক জের`});d.sort((e,t)=>{let n=c(e.date),r=c(t.date);return n===r?(e.createdAt?.toMillis?.()||e.createdAt?.toDate?.()?.getTime?.()||new Date(e.createdAt||0).getTime()||0)-(t.createdAt?.toMillis?.()||t.createdAt?.toDate?.()?.getTime?.()||new Date(t.createdAt||0).getTime()||0):n.localeCompare(r)});let f=Number(l.initialDue||0),p=0,g=0,v=0;d.forEach(e=>{e.receivedType===`Less`?v=i(v+(Number(e.paid)||0)):g=i(g+(Number(e.paid)||0)),p=i(p+(Number(e.bill)||0))});let y=i(f+p-g-v),{rowsArray:b}=m(f,d);_={customer:l,docs:d,settings:u,initialDue:f,billSum:p,paidSum:g,lessSum:v,running:y};let{page1HeaderHtml:x,page1ExtraHtml:S}=h(l,`৳ ${r(p)}`,`৳ ${r(g)}`,`৳ ${r(Math.abs(y))} ${y<0?`(Adv)`:``}`,y,u,`STATEMENT SUMMARY`,`সকল লেনদেন`,`সকল লেনদেন`);o.innerHTML=`
            ...
            </div>`}catch(e){console.error(e),o.innerHTML=`<div class="m3-card text-center py-12 text-red-400 font-bold max-w-md mx-auto">স্টেটমেন্ট লোড করতে ব্যর্থ!</div>`}}window.printPublicStatement=async()=>{if(!_)return;let{customer:e,docs:t,settings:n,initialDue:i,billSum:a,paidSum:o,running:s}=_,c=document.getElementById(`print-receipt-container`);c||(c=document.createElement(`div`),c.id=`print-receipt-container`,document.body.appendChild(c));let{rowsArray:u}=m(i,t),{page1HeaderHtml:p,repeatHeaderHtml:g,page1ExtraHtml:v,tableColHeaderHtml:y,signatureHtml:b}=h(e,`৳ ${r(a)}`,`৳ ${r(o)}`,`৳ ${r(Math.abs(s))} ${s<0?`(Adv)`:``}`,s,n,`STATEMENT SUMMARY`,`সকল লেনদেন`,`সকল লেনদেন`),[x,S,C]=l().split(`-`),w=await d({rowsArray:u,page1HeaderHtml:p,repeatHeaderHtml:g,tableColHeaderHtml:y,page1ExtraHtml:v,summaryHtml:``,signatureHtml:b,formattedDate:`${C}/${S}/${x}`});f(w)},window.renderPublicStatementView=v;export{g as printStatement,v as renderPublicStatementView};